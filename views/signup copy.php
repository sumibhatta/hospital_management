...
<h1 class="signup-h1"><center>SignUp</center></h1>
...
<div class="login-form form">
        ...
        <input type="email" placeholder="example@hello.com" name="email">
        <br/>
        ...
        <br/>
            ...
            <br><button class="button-index-one haha login-button" type="submit" value="Submit">Submit</button>
        </form>
</div>
